            ...
            <form>
                <div class="form-row">
                    <div class="form-group col-md-7">
                        ...
                        <input class="form-control" type="tel" id="example-tel-input" placeholder="Card type will be detected..." maxLength='17' required />
                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputPassword4">Security Code</label>
                        <input type="password" class="form-control" id="inputPassword4" placeholder="" maxLength="4" required />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
